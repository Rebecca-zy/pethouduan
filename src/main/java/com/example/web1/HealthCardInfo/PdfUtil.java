...
public class PdfUtil {
     ...
     */
    public static String imagesToPdf(String outPdfFilepath, File[] imageFiles) throws Exception {
        ...
        String outPut = urlName  + date + "/" + fileName;
        System.out.println(filePath+fileName);
        try{
            File file = new File(filePath+fileName);
            ////
            FileWriter a=new FileWriter(filePath+fileName);
            ////
            //创建一个document对象。
